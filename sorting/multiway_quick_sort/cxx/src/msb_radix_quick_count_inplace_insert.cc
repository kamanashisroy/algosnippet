...
/*
msb_radix_quick_count_inplace_insert.cc file is part of Algosnippet.
...
#include <iostream>
#include <cassert>
#include "msb_radix_quick_count_inplace_insert.h"
using namespace std;
using namespace algo_snippet::sorting;

void test_it() {
    msb_radix_quick_count_inplace_insert alg;
