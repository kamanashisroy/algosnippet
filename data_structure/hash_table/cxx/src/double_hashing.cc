...
/*
double_hashing.cc file is part of Algosnippet.
...
static int test_hash_table() {
    ...
    hash_table_double_hashing<hash_t> mytable(test_order,0);
...
int main(int argc, char*argv[]) {
    ...
    hash_table_double_hashing<hash_t> mytable(table_order,0);
